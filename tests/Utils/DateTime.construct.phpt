...
test('Exception handling for invalid input', function () {
	...
	// Test case that might fail validation in fromParts but is tricky for constructor
	// Assert::exception(function () {
	//	 new DateTime('2024-02-31 10:00:00'); // Invalid day for February
	// }, \Exception::class); // Behavior might vary slightly across PHP versions
});
