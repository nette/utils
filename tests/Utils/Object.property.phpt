...
}, 'Nette\MemberAccessException', 'Cannot write to an undeclared property TestClass::$undeclared, did you mean $declared?');
...
Assert::exception(function () use ($obj) {
	$val = $obj->undeclared;
}, 'Nette\MemberAccessException', 'Cannot read an undeclared property TestClass::$undeclared, did you mean $declared?');
