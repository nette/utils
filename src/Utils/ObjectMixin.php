...
class ObjectMixin
{
	...
	{
		return ObjectHelpers::strictGet($class, $name);
	}
	...
	{
		return ObjectHelpers::strictCall($class, $method, $additionalMethods);
	}
	...
	{
		return ObjectHelpers::strictStaticCall($class, $method);
	}
